    ...
    <>
      ...
      >
        <ul className="flex flex-col px-2 ">
          <strong className="  p-2 text-gray-500 ">Projects</strong>
        </ul>
                ...
                {d.type === "Projects" ? (
                  <li className="grid-col-4">
                    <p
                      ...
                      className="block  hover:text-gray-300 px-4 py-2 text-md font-medium text-gray-700"
                    >
                      {d.name}
                    </p>
                  </li>
        ...
        <ul className="flex flex-col px-2 ">
          <strong className=" p-2 text-gray-500 ">Organizations</strong>
        </ul>
        ...
        <ul className="flex flex-col px-2 ">
          <strong className=" p-2 text-gray-500 ">function</strong>
        </ul>
        <ul className="flex flex-col p-1 ">
          {dashboardMenu.map((d, i) => {
            return (
        ...
        <button className="flex gap-2 mt-5  hover:text-gray-300 px-4 py-2 text-md font-medium text-gray-700">
          Log Out <LogOut />
        </button>
      </div>
    </>
