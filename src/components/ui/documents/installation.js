    ...
    <>
      <div className="font-sans p-8">
        ...
        <div className="flex flex-wrap gap-5 w-full">
          <Link href="/docs/nextjs" className="text-black">
            <div className="mt-5 flex flex-col h-[140px] w-[300px] shadow-md hover:shadow-lg hover:bg-gray-100 rounded-md border">
          ...
          <Link href="/docs/vitejs" className="text-black">
            <div className="mt-5 flex flex-col h-[140px] w-[300px] shadow-md hover:shadow-lg hover:bg-gray-100 rounded-md border">
              <div className="flex flex-col  p-5 py-6 mx-auto">
          ...
          <Link href="/docs/Remix" className="text-black">
            <div className="mt-5 flex flex-col h-[140px] w-[300px] shadow-md hover:shadow-lg hover:bg-gray-100 rounded-md border">
              <div className="flex flex-col  p-5 py-6 mx-auto">
          ...
          <Link href="/docs/astro" className="text-black">
            <div className="mt-5 flex flex-col h-[140px] w-[300px] shadow-md hover:shadow-lg hover:bg-gray-100 rounded-md border">
              <div className="flex flex-col  p-5 py-6 mx-auto">
        ...
        <div className="font-sans lg:p-8">
          <h1 className="  border-b p-5 font-bold text-start text-2xl text-black mb-6">
            JavaScript Guide
          </h1>
          ...
          <section className="mb-6">
            ...
            <p className="text-lg text-gray-700 mb-4">
              ...
              <code className="bg-gray-200 text-gray-700 px-2 py-1 rounded">
                tsx
              </code>{" "}
              flag in your{" "}
              <code className="bg-gray-200 text-gray-700 px-2 py-1 rounded">
    ...
    "paths": {
      "@/*": ["./*"]
        ...
        <div className="justify-between flex">
          ...
          <Link href="/docs/changelog" className="text-black">
            <p className="text-end p-2 px-5  border ">
              <ArrowRight />{" "}
            </p>
          </Link>
